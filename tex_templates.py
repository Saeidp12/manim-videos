...
# def persian_template():
#     """Return a simple Tex Template suitable for persian typing"""
#     preamble = r"""
...
class TexTemplateLibrary:
    ...
    persian = TexTemplate(
        tex_compiler = "xelatex",
        output_format=".xdv",
        preamble = _persian_preamble
    )
    """Persian TeX template with only basic XePersian and some math packages loaded"""
